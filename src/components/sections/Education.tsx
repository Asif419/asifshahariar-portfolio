  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto">
        <h2 className="text-xl md:text-3xl font-bold text-gray-900 mb-12">Education</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 border-2 rounded-lg shadow-md flex flex-col items-center transition-all duration-300 hover:scale-105 hover:shadow-xl group">
            ...
            <h3 className="text-sm md:text-xl font-semibold text-gray-800 mb-2 transition-all duration-300 group-hover:text-blue-600 group-hover:md:text-3xl">
              MSc in Data Science
            </h3>
            <p className="text-sm md:text-base text-gray-600 transition-all duration-300 group-hover:text-gray-800">Tampere University, Finland</p>
          ...
          <div className="bg-white p-6 border-2 rounded-lg shadow-md flex flex-col items-center transition-all duration-300 hover:scale-105 hover:shadow-xl group">
            <Image
              ...
              className="w-32 h-32 mb-4 rounded-full object-cover transition-all duration-300 group-hover:w-40 group-hover:h-40 group-hover:mb-6 group-hover:-translate-y-4"
            />
            <h3 className="text-sm md:text-xl font-semibold text-gray-800 mb-2 transition-all duration-300 group-hover:text-blue-600 group-hover:md:text-2xl">
              BSc in Computer Science and Engineering
            </h3>
            <p className="text-sm md:text-base text-gray-600 transition-all duration-300 group-hover:text-gray-800 group-hover:text-">Daffodil International University, Bangladesh</p>
