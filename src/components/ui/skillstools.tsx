...
const Tools = [
  { name: 'Git', icon: '/assets/icons/git.png', expertise: 5 },
  { name: 'Docker', icon: '/assets/icons/docker.png', expertise: 1 },
  { name: 'Firebase', icon: '/assets/icons/firebase.png', expertise: 4 },
  { name: 'JWT', icon: '/assets/icons/jwt.png', expertise: 4 },
  { name: 'Stripe', icon: '/assets/icons/stripe.png', expertise: 4 },
  { name: 'VS Code', icon: '/assets/icons/vscode.png', expertise: 5 },
]

export default function SkillsTools() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-8 mb-7">
      {/* Left Side: Languages Title with Outer Line */}
      <div className="flex items-start md:items-center pl-4 w-1/3 md:w-[35%] justify-center">
      ...
      <div className="flex flex-row md:flex-wrap gap-1 md:gap-4 justify-center w-full md:w-[65%]">
        {Tools.map((item) => (
          <div key={item.name} className="group relative flex flex-col items-center w-auto">
            {/* Language icon */}
            <motion.div
