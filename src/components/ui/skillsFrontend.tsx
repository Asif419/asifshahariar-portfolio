...
const Frontend = [
  { name: 'React.js', icon: '/assets/icons/react.png', expertise: 5 },
  { name: 'Next.js', icon: '/assets/icons/next.png', expertise: 4 },
  { name: 'Tailwind CSS', icon: '/assets/icons/tailwind.png', expertise: 5 },
  { name: 'HTML5', icon: '/assets/icons/html.png', expertise: 5 },
  { name: 'CSS3', icon: '/assets/icons/css.png', expertise: 4 },
]
